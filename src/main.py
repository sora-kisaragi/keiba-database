...
if __name__ == "__main__":
    ...
    parser.add_argument('--jockey_id', type=str, default="00666", help='騎手IDを入力してください default: 00666 武豊')
    parser.add_argument('--horse_id', type=str, default="2017105319", help='馬IDを入力してください default: 2017105319 エフフォーリア')
    parser.add_argument('--no_scraping', action='store_false', help='スクレイピングを行わない場合に指定 default: True')
    parser.add_argument('--skip_scraping', action='store_true', help='データが存在する場合スクレイピングをスキップする場合に指定 default: False')
